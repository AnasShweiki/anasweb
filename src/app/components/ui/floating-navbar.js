        ...
        {navItems.map((navItem, idx) => (
          <Link
            ...
            className={cn(
              ...
              "text-sm sm:text-base" // Use different text sizes for different screen sizes
            )}
          >
